...
wngqd2=wing_quadrant(sld, sect1=sect2, sect2=sect3, control_names=['aileron', 'tab'], control_axpercs_x=[[0.75, 0.75], [0.9, 0.9]], control_axpercs_thickness=[[0.5, 0.5], [0.5, 0.5]])
